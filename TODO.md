...
<!-- OPEN -->
- [ ] [High] Voxel placement: AR tap-to-place — raycast hit on plane spawns voxel once; subsequent taps ignored outside Edit > Placement *(2026-04-21)*
- [ ] [High] Voxel placement: VoxelController — MonoBehaviour owning dimensions, position, rotation; exposes Resize, MoveTo, Rotate methods *(2026-04-21)*
...
- [ ] [High] Voxel placement: Edit/Done UI — Done locks voxel; Edit reveals Scale/Placement/Rotation sub-buttons; state machine drives active mode *(2026-04-21)*
<!-- /OPEN -->
